export const Footer = () => {
  return (
    <footer className="bg-gradient-to-b from-[#0a0a0a] via-black to-gray-800">
      <div className="mx-auto lg:max-w-6xl xl:max-w-7xl px-4 py-16 sm:px-6">
        <div className="lg:flex lg:items-start lg:gap-8">
          ...
          <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
            ...
            <div className=" sm:col-span-1">
              <p className="text-white font-bold">Helpful Links</p>
