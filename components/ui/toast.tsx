...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={cn(
      ...
      "group-[.success]:border-white/40 group-[.success]:text-white group-[.success]:hover:bg-green-600",
      "group-[.warning]:border-white/40 group-[.warning]:text-white group-[.warning]:hover:bg-yellow-600",
      "group-[.info]:border-white/40 group-[.info]:text-white group-[.info]:hover:bg-blue-600",
      className
    )}
    {...props}
  />
